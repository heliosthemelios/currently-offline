...
MOUCHE_IMG.src = '../../../assets/images/img_mouche/mouche.png';
const TAPETTE_IMG = new Image();
TAPETTE_IMG.src = '../../../assets/images/img_mouche/tapetteMouche.png';
const ECRASE_MOUCHE_IMG = new Image();
ECRASE_MOUCHE_IMG.src = '../../../assets/images/img_mouche/moucheEcrase.png';
const FOND_IMG = new Image();
FOND_IMG.src = '../../../assets/images/img_mouche/fond.png';
